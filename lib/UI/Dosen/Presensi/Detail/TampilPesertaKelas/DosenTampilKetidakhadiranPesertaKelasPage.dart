...
class DosenTampilKetidakhadiranPesertaKelasPageTes extends StatefulWidget {
  @override
  _DosenTampilKetidakhadiranPesertaKelasPageTesState createState() =>
      _DosenTampilKetidakhadiranPesertaKelasPageTesState();
}

class _DosenTampilKetidakhadiranPesertaKelasPageTesState
    extends State<DosenTampilKetidakhadiranPesertaKelasPageTes> {
  int idkelas = 0;
  int pertemuan = 0;
                                      ...
                                      DataRow(cells: [
                                        ...
                                        DataCell(MaterialButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await dataMahasiswaAnulir.setString(
                                                'npm',
                                                tampilKehadiranPesertaKelasResponseModel
                                                    .data[i].npm);
                                            await dataMahasiswaAnulir.setString(
